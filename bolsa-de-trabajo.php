...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Bolsa de Trabajo | Universidad Privada Boliviana</title>
    ...
    <body>
        ...
        <div id="contenedor">
            ...
            <div id="cuerpo2">
                <div id="title">Bolsa de Trabajo Cochabamba</div>  
                <div id="box">                   
                    ...
                    <span id="tt">Industrias Venado</span>
                    <p id="carrera">Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
                    Minima, repellat, quaerat tempora perspiciatis nam doloremque animi itaque perferendis 
                    facilis officia alias laboriosam veniam quisquam minus corrupti ab vero harum molestias.
                    </p>
                    <p id="carrera">
                ...
                <div id="box">
                    ...
                    <span id="tt">Cervecer&iacute;a Boliviana Nacional </span>
                    <p id="carrera">Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
                    Minima, repellat, quaerat tempora perspiciatis nam doloremque animi itaque perferendis 
                    facilis officia alias laboriosam veniam quisquam minus corrupti ab vero harum molestias.
                    </p>
