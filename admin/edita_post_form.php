<?php 
		require_once("header.php");
			...
			$id=$_GET['id'];
			$sql_edita_posts="SELECT * FROM upb_post WHERE idupb_post='$id'";
			$res=mysql_query($sql_edita_posts,$con);
...
<tr>
	...
	<form name="form" method="post" action="q/edita_post.php" enctype="multipart/form-data">
     <input name="idupb_post" type="hidden" value="<?php echo $reg["idupb_post"];?>"/>
    <tr valign="top">
	<td>
		<!-- start id-form -->
		...
		<td>	
		  <p>
		    <select name="tipo_post" class="styledselect_form_1">
		      <option <?php if($reg["tipo_post"]=="main"){echo 'selected';}else{echo '';}?> value="main">Principal</option>
		      <option <?php if($reg["tipo_post"]=="side"){echo 'selected';}else{echo '';}?> value="side">Side</option>
		    </select>
		</td>
		<td></td>
		</tr>
		<tr>
			...
			<td><input name="autor" type="text" class="inp-form" value="<?php echo $reg["autor"];?>"/></td>
			<td></td>
		</tr>
        <tr>
			<th valign="top">Titulo Post:</th>
			<td><input name="titulo_post" type="text" class="inp-form" value="<?php echo $reg["titulo_post"];?>"/></td>
			<td></td>
		</tr>
         
        <tr>
		<th valign="top">Descripci&oacute;n Post:</th>
		<td><textarea name="descripcion_post" rows="" cols="" class="form-textarea" ><?php echo $reg["descripcion_post"];?></textarea></td>
		<td></td>
	</tr>
    <tr>
			<th valign="top">Nombre Imagen:</th>
			<td><input name="nombre_foto" type="text" class="inp-form" value="<?php echo $reg["imagen_post"];?>"/></td>
			<td></td>
		</tr>
        <tr>
	<tr>
			<th valign="top">Imagen Anterior:</th>
			<td> <img src="<?php echo $base_url."admin/uploads_posts/".$reg['imagen_post'];?>" width="150" height="100"/> </td>
			<td></td>
		</tr>
        <tr>
