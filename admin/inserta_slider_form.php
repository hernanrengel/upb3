...
<tr>
    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0">
	<form name="form" method="post" action="q/procesa_slider.php" enctype="multipart/form-data">
    <tr valign="top">
	<td>
		<!-- start id-form -->
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<th valign="top">Tipo Slider:</th>
		<td>	
		  <p>
		    <select name="tipo_slider" class="styledselect_form_1">
		...
		<tr>
			...
			<td><input name="titulo_slider" type="text" class="inp-form" /></td>
			<td></td>
		</tr>
        <tr>
			<th valign="top">Nombre Slider:</th>
			<td><input name="nombre_slider" type="text" class="inp-form" /></td>
			<td></td>
		</tr>
        <tr>
	<th>Imagen:</th>
