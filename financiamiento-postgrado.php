...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Financiamiento de Postgrado | Universidad Privada Boliviana</title>
    ...
    <body>
    	...
    	<div id="cuerpo2">
                <div id="title">Financiamiento Postgrado</div>
                <div id="box">
                <h2>Opciones de Financiamiento</h2>
				<h2>EDUCAPRO</h2>
                    <p id="carrera">Contacto: Cochabamba: 4485207 - La Paz: 2115156 - SantaCruz: 3145834</p>
                    <p id="carrera">BANCO NACIONAL</p>
                    <p id="carrera">Contacto: Cochabamba: 4153999</p>
                </div>               
            </div>
        </div>
