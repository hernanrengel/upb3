...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Informaciones | Universidad Privada Boliviana</title>
        ...
        <div id="contenedor">
            ...
            <div id="cuerpo2">
                ...
                <div id="title">Programas de idiomas Extranjeros</div>
                    ...
                    <p id="carrera">Debes presentar un certificado original de suficiencia del idioma (TOEFL, SAT, o ELASH) con                    
                    una nota suficiente para eximir los distintos niveles del programa. SI CERTIFICAS LA SUFICIENCIA DURANTE TU                    
                    PRIMER SEMETRE EN LA UPB NO PAGARAS POR LOS CERTIFICADOS EXIMIDOS. A partir de tu segundo semestre,                    
