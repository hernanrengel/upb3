				<ul class="nav">
                	<li><a href="index.php">Inicio UPB
                    	<i class="icon-home"></i>
                    	</a>
                    	<ul>
                        	<li><a href="acerca.php">&iquest;Qu&eacute; es la UPB?</a></li>
                    ...
                    <li><a href="pregrado_cbba.php">Pregrado
                    ...
                    <li><a href="extension.php">Extensi&oacute;n
